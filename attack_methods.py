...
parser.add_argument("--image_width", type=int, default=112, help="Width of each input images.")
parser.add_argument("--image_height", type=int, default=112, help="Height of each input images.")
parser.add_argument("--image_resize", type=int, default=130, help="Height of each input images.")
...
def ensemble_input_diversity(input_tensor, idx):
    # [560,620,680,740,800] --> [112, 120, 140, 160]
    rnd = torch.randint(opt.image_width, [112, 120, 140, 160][idx], ())
    rescaled = F.interpolate(input_tensor, size = [rnd, rnd], mode = 'bilinear', align_corners=True)
    h_rem = [112, 120, 140, 160][idx] - rnd
    w_rem = [112, 120, 140, 160][idx] - rnd
    pad_top = torch.randint(0, h_rem, ())
    pad_bottom = h_rem - pad_top
    pad_left = torch.randint(0, w_rem, ())
    pad_right = w_rem - pad_left
